...
def determine_5_year_resistance(local_max_df, tolerance=0.03):
    """
    ...
    cluster_info = [(np.mean(c), len(c)) for c in clusters]
...
def find_clustered_resistance_breakout(
    ...
    cluster_res = determine_5_year_resistance(local_max_df, tolerance=tolerance)
